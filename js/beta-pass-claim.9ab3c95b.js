! function(t, e, i, s) {
    ...
    n.Defaults = {
        ...
        filter: ["width", "items", "settings"],
        run: function() {
            for (var t = this.settings.rtl ? 1 : -1, e = this._clones.length + this._items.length, i = -1, s = 0, n = []; ++i < e;) s = n[i - 1] || 0, n.push(s + (this._widths[this.relative(i)] + this.settings.margin) * t);
            this._coordinates = n
        }
    }, {
        filter: ["width", "items", "settings"],
...
function(t, e, i, s) {
    ...
    n.Defaults = {
        ...
        var s, n = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "",
            o = e.find("img"),
            r = "src",
            a = "",
        ...
        "youtube" === i.type ? l("//img.youtube.com/vi/" + i.id + "/hqdefault.jpg") : "vimeo" === i.type ? t.ajax({
            type: "GET",
...
function(t, e, i, s) {
    ...
    h.csstransitions() && (t.support.transition = new String(n("transition", !0)), t.support.transition.end = a.transition.end[t.support.transition]), h.cssanimations() && (t.support.animation = new String(n("animation", !0)), t.support.animation.end = a.animation.end[t.support.animation]), h.csstransforms() && (t.support.transform = new String(n("transform", !0)), t.support.transform3d = h.csstransforms3d())
}(window.Zepto || window.jQuery, window, document);
//# sourceMappingURL=beta-pass-claim.9ab3c95b.js.map